...
import net.esati.common.constant.HttpMethod;
...
class HttpHandle {
    ...
    private <T> T execute(String url, Map<String, ?> params, Map<String, ?> headers, Object body, Integer connectTimeout, Integer readTimeout,
        ...
        if (params != null) {
            paramsStr = HttpUrlUtil.paramUnicodeSort(params, true, false);
        ...
        try {
            ...
            if (url.split(":")[0].equals("https")) {
                ...
                TrustManager[] tm = {new HttpsProcessUtil()};
            ...
            throw new HttpExceptionUtil(result.toString());
        } catch (Exception e) {
            throw new HttpExceptionUtil(e.getMessage());
        } finally {
